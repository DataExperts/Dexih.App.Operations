...
//                    throw new Exception("The connection could not be started due to a missing assembly.  The assembly name is: " + Assembly + ", and class: " + Class + ", and expected in directory: " + GetType().GetTypeInfo().Assembly.Location + ".  Have the transforms been installed?");
//
